...
<article <?php post_class( 'group flex flex-col min-w-0' ); ?>>
	...
	<a class="block no-underline overflow-hidden rounded-2xl border border-slate-200/50 dark:border-zinc-800/80 shadow-sm" href="<?php the_permalink(); ?>">
		...
		<?php else : ?>
			<div class="flex aspect-[3/2] items-center justify-center bg-white dark:bg-zinc-900 border border-slate-200/50 dark:border-zinc-800/80 p-6 group-hover:scale-105 transition-transform duration-500">
