		...
		<div class="ss-container">
			...
			<div class="grid gap-y-16 gap-x-10 lg:grid-cols-[minmax(0,760px)_320px]">
				...
				<div class="min-w-0">
					...
					<div class="ss-card mt-6 lg:hidden rounded-3xl p-6 grid gap-5 bg-white dark:bg-[#262B4E]/40 shadow-sm border border-slate-200/60 dark:border-zinc-800/80 font-sans">
				...
				<aside class="grid content-start gap-6">
					...
					<!-- Identitas Komunitas Card (Desktop only) -->
					<div class="ss-card hidden lg:grid rounded-3xl p-6 gap-5 bg-white dark:bg-[#262B4E]/40 shadow-sm border border-slate-200/60 dark:border-zinc-800/80 font-sans">
						<h3 class="ss-info-title m-0 text-slate-900 dark:text-zinc-50 text-base font-black uppercase tracking-wide"><?php esc_html_e( 'Identitas Komunitas', 'sukusastra' ); ?></h3>
